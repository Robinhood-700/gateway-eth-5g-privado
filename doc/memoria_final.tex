...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \textbf{Validación del firmware simulado en la placa de desarrollo: } El flash del firmware simulado funcionó correctamente con el primer intento y conseguí verificar la lógica del firmware con la salida en consola. En la salida del comando 'idf.py -p /dev/ttyUSB1 -b 115200 flash monitor' se puede observar que las llamadas a las funciones que simulan el comportamiento del firmware se hacen correctamente y en orden. Hice un pipe en bash de la salida al archivo run\_results.txt y en este archivo pude verificar que la lógica del firmware es correcta. El firmware simulado se encuentra en la misma topología del proyecto que el firmware original, con el prefijo "mock" para cada componente. Se puede hacer el build del firmware original comentando el archivo mock\_app\_main.c entero, y descomentando app\_main.c. 
	\end{enumerate}
...
\end{itemize}
Todo el desarrollo de las pácticas se ha realizado con mi portátil personal HP usando \href{https://fedoraproject.org/}{Fedora Linux 43} sobre la placa \href{https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32/esp32-ethernet-kit/user_guide.html}{ESP32-Ethernet-Kit v1.2} detallada en el anexo de esta memoria.
\section{Anexos.}
\begin{itemize}
	...
	\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado}{Repositorio GitHub} en el cual se almacena el código fuente del proyecto además de los resultados obtenidos.
		\begin{itemize}
			\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado/blob/main/README.md}{Descripción} del proyecto en GitHub.
			\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado/tree/main/resultados}{Colección de resultados} del build y la simulación del firmware.
			\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado/tree/main/firmware/esp32_gateway}{Código fuente} del firmware simulado.
			\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado/blob/main/doc/memoria_final.tex}{Código fuente} \LaTeX de la memoria.
			\item \href{https://github.com/Robinhood-700/gateway-eth-5g-privado/blob/main/doc/descripcion_funciones.md}{Descripción} de todas las funciones del firmware original.
		\end{itemize}
	...
	\item Datasheet del chip ethernet \href{https://www.lcsc.com/datasheet/C703537.pdf?spm=wm.sxq.inf.ggs&lcsc_vid=RlVdUlUEQVNXX1RRRQNaUlxeEwReBgJQQVNaAl1TRFExVlNeRVVZVlNUT1JYVTsOAxUeFF5JWAUbBA8CAgIFAAtIFA4DSA%3D%3D}{IP101GRI}
	\item Datasheet del chip ethernet \href{https://docs.wiznet.io/img/products/w5500/W5500_ds_v110e.pdf}{W5500}
	\item \href{https://fedoraproject.org/}{Fedora Linux 43}
	\item \href{https://joplinapp.org/}{Joplin}, aplicación de notas utilizada para la elaboración del archivo descripcion\_funciones.md.
\end{itemize}
\thispagestyle{fancy}
