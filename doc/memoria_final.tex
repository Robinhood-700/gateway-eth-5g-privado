...
\end{itemize}
Todo el desarrollo de las pácticas se ha realizado con mi portátil personal HP usando \href{https://fedoraproject.org/}{Fedora Linux 43} sobre la placa ESP32-Ethernet-Devkit v1.2 detallada en el anexo de esta memoria.
\section{Anexos.}
\begin{itemize}
